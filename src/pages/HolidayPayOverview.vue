    ...
    <div class="grid grid-cols-12 items-center pb-2">
      ...
      <div class="col-span-8 flex items-center space-x-4">
        ...
        <div class="flex space-x-6">
          <button v-for="tab in tabs" :key="tab" @click="activeTab = tab" :class="[
            'pb-1 border-b-2 font-semibold cursor-pointer',
            activeTab === tab
      ...
      <div class="col-span-4 flex items-center justify-between p-2 ml-2">
        ...
        <div class="flex items-center gap-2">
          ...
          <ArrowDownTrayIcon class="w-5 h-5 text-blue-500 cursor-pointer" />
        ...
        <div class="flex items-center gap-2">
          <!-- First Grid Button -->
          <button class="p-1 hover:bg-blue-50 cursor-pointer">
