                    ...
                    <table class="w-full">
                        <thead>
                            <tr>
                                ...
                                <th class="px-6 py-3 text-left text-base font-medium text-[#022652]">
                                    Jurisdiction</th>
                                <th class="px-6 py-3 text-center text-base font-medium text-[#022652]">
                                    Employee Count</th>
                                <th class="px-6 py-3 text-left text-base font-medium text-[#022652]">
                                    Status</th>
                            </tr>
                        ...
                        <tbody class="bg-[#F4F4F4]">
                            <tr v-for="(company, index) in companies" :key="index" class="hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-[#333333]">{{ company.companyNumber
                                    }}</td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-[#333333]">{{ company.industry }}
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-[#333333]">{{ company.jurisdiction
                                }}
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap text-center text-sm text-[#333333]">{{
                                    company.employeeCount
                                }}</td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <span
                                        class="inline-flex px-2 py-1 text-xs font-semibold rounded-full text-[#5EBA4F]">
                                        {{ company.status }}
                                    </span>
                                </td>
                            </tr>
