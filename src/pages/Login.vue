<template>
  <div class="min-h-screen flex flex-col md:flex-row">
    ...
    <div class="flex-1 bg-gradient-to-r from-[#195384] to-[#11376D] hidden md:flex flex-col p-6 md:p-[100px]">
      <!-- Logo at top -->
      <div>
        <img :src="logoImage" alt="Company Logo" class="h-8 object-contain" />
      </div>
          ...
          <form @submit.prevent="handleLogin" class="space-y-4">
            ...
            <div>
              <input v-model="email" type="email" placeholder="Email Address" required
                class="w-full px-4 py-3 rounded-lg bg-[#EFF2F6] placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent" />
            </div>

            <!-- Password Field -->
            <div class="relative">
              <input v-model="password" :type="showPassword ? 'text' : 'password'" placeholder="Password" required
                class="w-full px-4 py-3 pr-12 rounded-lg bg-[#EFF2F6] placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent" />
